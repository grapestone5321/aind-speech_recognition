...
def deep_rnn_model(input_dim, units, recur_layers, output_dim=29):
    ...
    simp_rnn = GRU(units, activation='relu', return_sequences=True, implementation=2)(input_data)
    bn_rnn = BatchNormalization()(simp_rnn)
    for i in range(recur_layers):
           deep_rnn = GRU(units, activation='relu', return_sequences=True, implementation=2)(bn_rnn)
...
def final_model(input_dim, filters, kernel_size, conv_stride,
    ...
    bn_rnn = BatchNormalization()(simp_rnn)
    bidir_rnn = Bidirectional(GRU(units, activation='relu', return_sequences=True, implementation=2))(bn_rnn)
